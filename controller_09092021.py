...
import sys
import os
sys.path.insert(1,'/home/niklaus/Downloads/exo_arm/scripts/hebi_wp4_python/hebi-python-examples/util')
import math_utils
sys.path.insert(1,'/home/niklaus/Downloads/exo_arm/scripts/hebi_wp4_python/hebi-python-examples/kits/arm/gains')
...
def get_group():
    ...
    try:
        gains_command.read_gains("/home/niklaus/Downloads/exo_arm/scripts/hebi_wp4_python/hebi-python-examples/kits/arm/gains/exoarm_gains.xml")
    ...
    model = hebi.robot_model.import_from_hrdf("/home/niklaus/Downloads/exo_arm/scripts/hebi_wp4_python/hebi-python-examples/kits/arm/hrdf/exoarm_hrdf.hrdf")
...
if __name__ == "__main__":
    ...
    home_position()
    xyz = np.expand_dims(np.array([0.1674551964,0.637288332, 0.2603000104]),axis=-1)
    xyz_targets = np.expand_dims(np.array([0.26008,0.64898,0.260300]),axis=-1)
    #xyz_targets = np.array([[0.759847, 0.433597, 0.343866, 0.574577, 0.712394],
    #                        [0.544029, 0.722663, 0.389566, 0.124099, 0.0273318],
    #                        [0.236279, 0.236279, 0.236279, 0.236279, 0.236279]])
